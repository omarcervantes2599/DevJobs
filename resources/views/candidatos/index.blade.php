                                ...
                                <li class="p-3 flex items-center">
                                    ...
                                    <div>
                                        <a href="{{ asset('storage/cv/' . $candidato->cv) }}"
                                            class="inline-flex items-center shadow-sm px-4 py-1 border border-gray-300 text-sm leading-5 font-medium rounded-full text-gray-600 bg-white hover:bg-gray-50"
